...
SWIFT_MODULE_NAMESPACE_PUSH("EVReflection_CloudKit")
@class NSCoder;
@class NSDictionary;
...
SWIFT_CLASS("_TtC21EVReflection_CloudKit8EVObject")
...
SWIFT_CLASS("_TtC21EVReflection_CloudKit12CKDataObject")
@interface CKDataObject : EVObject
/// The unique ID of the record.
@property (nonatomic, strong) CKRecordID * _Nonnull recordID;
/// The app-defined string that identifies the type of the record.
@property (nonatomic, copy) NSString * _Null_unspecified recordType;
/// The time when the record was first saved to the server.
@property (nonatomic, copy) NSDate * _Nonnull creationDate;
/// The ID of the user who created the record.
@property (nonatomic, strong) CKRecordID * _Nullable creatorUserRecordID;
/// The time when the record was last saved to the server.
@property (nonatomic, copy) NSDate * _Nonnull modificationDate;
/// The ID of the user who last modified the record.
@property (nonatomic, strong) CKRecordID * _Nullable lastModifiedUserRecordID;
/// A string containing the server change token for the record.
@property (nonatomic, copy) NSString * _Nullable recordChangeTag;
/// Encoding the system fields so that we can create a new CKRecord based on this
@property (nonatomic, copy) NSData * _Nullable encodedSystemFields;
/// Implementation of the setValue forUndefinedKey so that we can catch exceptions for when we use an optional Type like Int? in our object. Instead of using Int? you should use NSNumber?
/// This method is in EVObject and not in NSObject extension because you would get the error: method conflicts with previous declaration with the same Objective-C selector
/// \param value The value that you wanted to set
///
...
///
- (nonnull instancetype)init:(CKRecord * _Nonnull)record;
...
///
- (CKRecord * _Nonnull)toCKRecord SWIFT_WARN_UNUSED_RESULT;
/// Put a dictionary recursively in a CKRecord
/// \param record the record
///
/// \param dict the dictionary
///
/// \param root used for expanding the property name
///
- (void)dictToCKRecord:(CKRecord * _Nonnull)record dict:(NSDictionary * _Nonnull)dict types:(NSDictionary * _Nonnull)types root:(NSString * _Nonnull)root;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
